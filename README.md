...
To run the console type `./console.py` in the terminal

### A Look At Interactive Mode 
```
$ ./console.py
(hbnb) help
...
$
```
#### Objects that can be handled With the Console
The console currently works with instances of the folowing Classes
...
```
## Authors :black_nib:
* **Simon Tagbor** <[bdbaraban](https://github.com/Simontagbor)>
* **Richard Anyadoe** <[sazad44](https://github.com/anyadoer)>
